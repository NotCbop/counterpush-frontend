...
export default function PlayerProfile() {
  ...
  // Display name - prioritize Minecraft
  const displayName = player.minecraftUsername || player.username || 'Unknown';
  const hasMinecraft = !!player.minecraftUuid;
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-dark-800 border border-dark-600 rounded-2xl p-8 mb-8">
            <div className="flex flex-col md:flex-row items-center gap-6">
              <div className="relative">
                {/* Avatar - MC head if linked, Discord if not */}
                <div className="w-32 h-32 rounded-xl bg-dark-600 flex items-center justify-center text-5xl overflow-hidden">
                  {player.minecraftUuid ? (
                    <img 
                      src={`https://mc-heads.net/avatar/${player.minecraftUuid}/128`} 
                      alt="" 
              ...
              <div className="text-center md:text-left flex-1">
                {/* Main name - Minecraft username or Discord */}
                <h1 className="font-display text-4xl mb-2">{displayName}</h1>
                
                {/* Discord info below if MC is linked */}
                {hasMinecraft && player.username && (
                  <div className="flex items-center justify-center md:justify-start gap-2 mb-3 text-gray-500">
                ...
                {/* Not linked warning */}
                {!hasMinecraft && (
                  <div className="flex items-center justify-center md:justify-start gap-2 mb-3 text-yellow-500/70">
                    <span className="text-sm">⚠️ Minecraft not linked</span>
                  </div>
                )}
          ...
          <div className="bg-dark-800 border border-dark-600 rounded-2xl p-6 mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-dark-700 rounded-xl p-4 text-center">
                <div className="text-2xl font-bold text-orange-400">{(displayStats.damage || 0).toLocaleString()}</div>
                <div className="text-gray-500 text-xs">Damage</div>
              </div>
              <div className="bg-dark-700 rounded-xl p-4 text-center">
                <div className="text-2xl font-bold text-pink-400">{(displayStats.healing || 0).toLocaleString()}</div>
                <div className="text-gray-500 text-xs">Healing</div>
              </div>
              <div className="bg-dark-700 rounded-xl p-4 text-center">
                <div className="text-2xl font-bold text-cyan-400">{displayStats.gamesPlayed || 0}</div>
                <div className="text-gray-500 text-xs">Games</div>
              </div>
              <div className="bg-dark-700 rounded-xl p-4 text-center">
                <div className="text-2xl font-bold text-emerald-400">{displayWinRate}%</div>
